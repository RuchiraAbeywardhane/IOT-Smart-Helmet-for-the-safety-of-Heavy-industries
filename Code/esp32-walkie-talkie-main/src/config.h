...
#define I2S_SPEAKER_SERIAL_CLOCK GPIO_NUM_34
#define I2S_SPEAKER_LEFT_RIGHT_CLOCK GPIO_NUM_35
#define I2S_SPEAKER_SERIAL_DATA GPIO_NUM_36
// Shutdown line if you have this wired up or -1 if you don't
#define I2S_SPEAKER_SD_PIN GPIO_NUM_33
